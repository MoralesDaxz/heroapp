...
export const HeroPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 max-w-5xl mx-auto">
      {/* Header Banner */}
      <div className="bg-linear-to-r from-slate-900 via-blue-900 to-slate-900 text-white rounded-t-2xl">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                ...
                <Badge
                  variant="secondary"
                  className={` text-white border-white/30 ${superheroData.universe === "DC" ? "bg-blue-600" : "bg-red-600"}`}
                >
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Tabs defaultValue="stats" className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8">
            <TabsTrigger value="stats" className="flex items-center gap-2 text-gray-700">
              <Gauge className="w-4 h-4" />
              Estadísticas
            </TabsTrigger>
            <TabsTrigger value="powers" className="flex items-center gap-2 text-gray-700">
              <Zap className="w-4 h-4" />
              Poderes
            </TabsTrigger>
            <TabsTrigger value="team" className="flex items-center gap-2 text-gray-700">
              <Users className="w-4 h-4" />
              Equipo
            </TabsTrigger>
            <TabsTrigger value="info" className="flex items-center gap-2 text-gray-700">

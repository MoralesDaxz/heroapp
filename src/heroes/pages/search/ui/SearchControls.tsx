...
export const SearchControls = () => {
  ...
  const strength = Number(searchParams.get("strength") ?? "0"); // trasnform to number for Slider component
    ...
    <>
      <div className="flex flex-col lg:flex-row gap-4 mb-8">
        ...
        <div className="flex flex-col md:flex-row gap-2">
          <Button
            variant={
              activeAccordion === "advance-filter" ? "default" : "outline"
            }
            className="h-12"
            onClick={() => {
              if (activeAccordion === "advance-filter") {
                setSearchParams((prev) => {
              ...
              setQueryParams("active-accordion", "advance-filter");
            }}
          >
